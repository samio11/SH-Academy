...
router.post("/create", (0, checkAuth_1.checkAuth)([user_interface_1.ERole.admin]), multer_config_1.multerUpload.single("file"), parseFormData_1.parseFormData, (0, validateRequest_1.default)(course_validation_1.courseValidation.createCourseSchema), course_controller_1.courseController.createCourse);
